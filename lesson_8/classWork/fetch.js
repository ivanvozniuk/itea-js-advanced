...
*/
	...
	const res = fetch("http://www.json-generator.com/api/json/get/cgwbLkTxnS?indent=2")
				.then(convertToJson)
				.then(humans => humans[getRandomInt(0, humans.length)])
				.then(randomHuman => (
					fetch("http://www.json-generator.com/api/json/get/bTBBXQabKG?indent=2")
						.then(convertToJson)
						.then(friends => ({
							name: randomHuman.name, 
