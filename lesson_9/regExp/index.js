...
/*
    ...
    Написать регулярное выражение которое найдет:
      1. Все слова.                                                 1. \w+ 
      2. Все совпадения букв от a до e,                             2. \ba\w*e\b
      3. Года, например 2004                                        3. \d{1,4} 
      4. Слова обернутые в [квадратныеКавычки]                      4. \[\w+\]
      5. Все форматы файлов .jpg / .png / .gif                      5. \w*\.(jpg|png|gif|mp3)
      6. Все email com.ua                                           6. \w+\@\w+\.\w+(\.\w+)?
      7. Все слова написанные с большой буквы                       7. \b[A-Z]\w+\b
      8. Найти телефон написаный по паттерну +00 (000) 000-00-00,   8. \b\+\d{2}\s\(\d{3}\)\s\d{3}\-\d{2}\-\d{2}\b
...
/*
	/с\.?\s([а-яії\s]+)|м\.?\s([а-яії’-\s]+)|смт\.?\s([а-яії’-\s]+)/gi
*/